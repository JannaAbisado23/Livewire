<div>
    <div class="">
        ...
        <div class="row mx-auto mt-5 mb-3 d-flex justify-content-between">
            <div class="col-md-3 text-white mb-5">
                <div class="card" style="height: 550px; background-color:red">
                    <div class="mt-2 mx-4">
                    ...
                    <div class="ms-3">
                        ...
                        <input type="range" class="form-range" min="100" max="1000" id="customRange2"
